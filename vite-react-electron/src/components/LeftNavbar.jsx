        ...
        <>
            <nav className="left-nav">
                <ul className="left-nav-vertical">
                    ...
                    <li className="left-nav-item"><a className="left-nav-link" onClick={() => onChangeScreen(2)}>Recommendation</a></li>
                    <li className="left-nav-item"><a className="left-nav-link" onClick={() => onChangeScreen(3)}>Invitations</a></li>
                    <li className="left-nav-item"><a className="left-nav-link" onClick={() => onChangeScreen(4)}>Review</a></li>
                </ul>
